...
class Isentropic{
  ...
  static findMFrom_A_by_Astar_mach_supersonic(ratio:number, gamma:number):number{
    // Numerical solution
...
class ObliqueShock{
  ...
  static find_shock_angle_solutions(M1: number, gamma: number, deflection: number):[number, number]{
