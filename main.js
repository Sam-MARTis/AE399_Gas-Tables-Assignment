...
class Isentropic {
    ...
    static findMFromMachAngle(angle, gamma) {
...
class NormalShock {
    ...
    static findM1FromPt2_by_Pt1(ratio, gamma) {
        let M = 1.0;
        let dM = max_M_step;
...
function calculateIsentropic() {
    ...
    const output = document.getElementById("isentropic_output_area");
    if (!input) {
...
function calculateNormalShock() {
    const input = document.getElementById("input_normalshock_number").value;
    const type = document.getElementById("normalshock_input_type").value;
    const output = document.getElementById("normalshock_output_area");
    if (!input) {
        output.textContent = "Please enter a value";
        return;
    }
...
function calculateObliqueShock() {
    const m1Input = document.getElementById("input_obliqueshock_M").value;
    const secondInput = document.getElementById("input_obliqueshock_2").value;
    const type = document.getElementById("obliqueshock_input_2_type").value;
    const output = document.getElementById("obliqueshock_output_area");
